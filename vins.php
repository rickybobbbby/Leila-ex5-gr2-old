<?php
  ...
  $tabVinsParSection = [];
  while($ligne = mysqli_fetch_assoc($resultatVins)) {
    $nomSection = $ligne["nomSection"];
    $tabVinsParSection[$nomSection][] = $ligne;
  }
?>     
      ...
      <nav class="nav-principale">
        <a href="menu.php" title="<?= $co_navMenusTitle; ?>">
        ...
        <a href="vins.php" class="actif" title="<?= $co_navVinsTitle; ?>">
    ...
    <div class="contenu-principal">
      ...
      <form class="frm-recherche" method="post">
        <label><?= $vi_rechercheEtiquette; ?>
          <input type="text" name="origine" placeholder="<?= $vi_recherchePlaceholder; ?>">
        </label>
      </form>
      <div class="carte">
        <?php foreach($tabVinsParSection AS $nomSection => $vins) : ?>
        <section>
          <h2><?= $nomSection; ?></h2>
          <ul>
            ...
            <li>
              <span>
                <span class="vin-nom"><?= $vin["nomVin"]; ?></span><br>
