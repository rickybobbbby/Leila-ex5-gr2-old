...
?>
    <div class="titre-page">
      ...
      <div class="info-utile">
        <p class="aujourdui"><?= $ac_infoHeureOuverture; ?></p>
        <p class="addresse"><?= $ig_adresse; ?></p>
        <p class="telephone"><?= $ig_noTel; ?></p>
      </div>
    ...
    <div class="contenu-principal">
      <h2><?= $ac_introTitre; ?></h2>
      <p><img src="images/accueil-cuisine.jpg" alt="<?= $ac_introImgAlt; ?>"><?= $ac_introP1; ?></p>
      <p><?= $ac_introP2; ?></p>
    </div>
